...
public class SoapRequest {
    ...
    public SOAPMessage depBoardWithDetailsRequest(String numRows, String crs, String filterType, String timeOffset, String timeWindow) throws Exception{
        // SOAP Body
        ...
        /* Print the request message for testing */
